        ...
        <div className="flex justify-between items-center w-full max-w-xl mx-auto">
          ...
          <div className="flex items-center gap-3 pointer-events-auto">
            <button 
              ...
              className="w-16 h-16 rounded-full bg-slate-800/90 border border-amber-500/40 text-amber-400 active:bg-amber-600 active:text-white flex items-center justify-center shadow-lg"
            >
              <ArrowLeft size={28} />
            </button>
            <button 
          ...
          <div className="flex items-center gap-4 pointer-events-auto">
            <button 
              ...
              className="w-16 h-16 rounded-full bg-red-950/90 border border-red-500/50 text-red-400 font-bold text-xl flex items-center justify-center"
            >
              X
            </button>
            <button 
              ...
              className="w-20 h-20 rounded-full bg-amber-500 text-slate-950 flex flex-col items-center justify-center shadow-2xl font-bold active:bg-amber-400"
            >
              <ArrowUp size={24} />
